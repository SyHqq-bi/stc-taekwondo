...
import { ShieldCheck, Trophy, Zap, ArrowRight, Award, Flame, LayoutDashboard } from 'lucide-react';
      ...
      <section className="relative pt-32 pb-16 lg:pt-40 lg:pb-24 z-10">
        <div className="max-w-7xl mx-auto px-6 grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
          ...
          <div className="lg:col-span-7 space-y-7">
            ...
            {/* Action Buttons (Kondisional Login) */}
            {!user ? (
              ...
              <div className="flex flex-wrap items-center gap-4 pt-1">
                <Link
                  ...
                  className="px-8 py-4 bg-slate-900 hover:bg-slate-800 text-white font-black text-xs tracking-wider uppercase rounded-2xl transition shadow-lg shadow-slate-900/20 flex items-center gap-2.5 active:scale-95"
                >
                  <LayoutDashboard size={16} /> BUKA DASHBOARD ({profile?.full_name?.split(' ')[0] || 'MEMBER'})
                </Link>
                <Link
                  to="/achievements"
                  className="px-8 py-4 bg-white hover:bg-slate-100 text-slate-900 font-bold text-xs tracking-wider uppercase rounded-2xl transition border border-slate-200/80 shadow-sm active:scale-95"
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-3.5 pt-6 border-t border-slate-200/80">
              <div className="p-3.5 bg-white border border-slate-200/80 rounded-2xl shadow-sm flex items-center gap-3">
                ...
                <div>
                  <h4 className="text-xs font-bold text-slate-900 uppercase">Resmi & Terdata</h4>
